...
const SOURCE_SEED = "sEdTK8kbf5D1LFneqzg5GkgjsWj4yRw"; // 🔑 Replace with the source wallet seed
const DESTINATION_ADDRESS = "r34iDusSuYCPPaiPV7RnnFCWeg8X9mCPrj"; // 🎯 Destination wallet address
